...
| `asset-specs/README.md` | 188 | Generating, reviewing, or replacing dino and biome art. Defines the spec schema, **reserves a silhouette class and body color per species**, and bans prescribed coordinates — read this before any art work |
